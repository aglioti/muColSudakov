...
|"/Results/Difermion/DileptonWithRadiation.mx"| {nExpeeRad, nExp\[Mu]\[Mu]Rad, nExp\[Tau]\[Tau]Rad, nExpem\[Nu]SI, \
nExp\[Mu]m\[Nu]SI, nExp\[Tau]m\[Nu]SI, nExp\[Nu]epSI, \
nExp\[Nu]\[Mu]pSI, nExp\[Nu]\[Tau]pSI} | $\mu\mu\to ee$, $\mu\mu\to \mu\mu$ , $\mu\mu\to \tau\tau$, $\mu\mu\to e^-\bar{nu}$, $\mu\mu\to \nu e^+$, $\mu\mu\to \mu^-\bar{nu}$, $\mu\mu\to \nu \mu^+$,$\mu\mu\to \tau^-\bar{nu}$ and $\mu\mu\to \nu \tau^+$, With Radiation |
|------|-------------------|-------------------|
